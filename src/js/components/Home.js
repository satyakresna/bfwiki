    ...
    <div class="flex flex-col justify-center items-center m-auto">
      <article class="p-4 mt-16">
        ...
        <div class="leading-loose">
          <p>This website provides list of omni units and dbbs from Brave Frontier Global.</p>
        ...
        <div class="leading-loose">
          <p>If you have any feedback about feature(s) on this website please submit form in <a href="https://github.com/satyakresna/bfwiki/issues" target="_blank" class="underline text-blue-700">github.com/satyakresna/bfwiki/issues</a></p>
        </div>
